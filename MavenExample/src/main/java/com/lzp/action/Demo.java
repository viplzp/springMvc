...
public class Demo {
	...
	public static void main(String[] args) {
		...
		reqMessage = "<Finance><Message id='" + messageid + "'><AQReq id='AQReq'><version>1.0.1</version><instId>ZBD</instId><certId>0006</certId><date>" + sdf.format(date) + "</date><bindSerialNo>PP201608221602030009959908</bindSerialNo><AccNo></AccNo>" + "<extension></extension></AQReq></Message></Finance>";// 账户余额查询
		...
		//查询开户信息
		reqMessage = "<Finance><Message id='" + messageid + "'><QCReq id='QCReq'><Cstno>100003026488</Cstno><date>" + sdf1.format(date) + "</date><version>1.0.1</version><instId>ZBD</instId><certId>0006</certId></QCReq></Message></Finance>";// 6.30
																																																																							// 项目基本信息查询
